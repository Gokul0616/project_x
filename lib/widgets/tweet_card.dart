...
//               children: [
//                 // Profile Avatar - smaller for classic look (not clickable for navigation)
//                 GestureDetector(
//                   onTap: () {
...
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       // User Info and Time - Responsive Twitter style
//                       Row(
//                         children: [
//                           // Display name with flexible width and overflow handling
//                           Flexible(
//                             flex: 2,
//                             child: Text(
...
//                           // Username with flexible width and overflow handling
//                           Flexible(
//                             flex: 2,
//                             child: Text(
...
//                           ),
//                           const SizedBox(width: 4),
//                           // Separator and time - these should always be visible
//                           Text(
//                             '·',
//                             style: TextStyle(
//                               color: Theme.of(
...
//                       // Tweet Text with hashtag and mention highlighting
//                       RichTweetText(
//                         text: tweet.content,
//                         style: TextStyle(
//                           fontSize: 15,
...
//                       if (tweet.mediaFiles.isNotEmpty) ...[
...
//                         // Backward compatibility for old tweets
//                         const SizedBox(height: 8),
//                         ClipRRect(
